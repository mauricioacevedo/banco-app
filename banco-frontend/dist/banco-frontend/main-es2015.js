...
let AddAsesorDialogComponent = class AddAsesorDialogComponent {
    constructor(dialogRef, datos, route, router) {
...
AddAsesorDialogComponent.ctorParameters = () => [
...
let AsesorComponent = class AsesorComponent {
...
AsesorComponent.ctorParameters = () => [
...
let ConsumoDialogComponent = class ConsumoDialogComponent {
    constructor(dialogRef, data, datos) {
        this.dialogRef = dialogRef;
        this.datos = datos;
...
ConsumoDialogComponent.ctorParameters = () => [
...
let ConsumoComponent = class ConsumoComponent {
    constructor() { }
    ngOnInit() {
    }
};
